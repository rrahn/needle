...
int run_needle_estimate(seqan3::argument_parser & parser)
{
    ...
    try
    {
        call_estimate(args, expressions, file_out, search_file, path_in);
    }
...
{
    seqan3::argument_parser needle_parser{"needle", argc, argv, true, {"estimate", "ibf", "ibfmin", "insert",
                                                                       "minimiser", "search", "stats", "test"}};
